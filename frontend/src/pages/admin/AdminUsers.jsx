      ...
      {confirmId && (
        ...
        >
          <div
            ...
            className="anim-up"
          >
            <div style={{ width: 52, height: 52, background: "#FFF5F5", border: "1px solid #f5c6cb", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
              <svg width="26" height="26" fill="none" stroke="var(--error)" viewBox="0 0 24 24" strokeWidth={2}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <button
                onClick={deleteUser}
                disabled={!!deleting}
                style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, background: "var(--error)", color: "#fff", border: "none", height: 46, fontFamily: "Manrope, sans-serif", fontWeight: 700, fontSize: 14, letterSpacing: "0.04em", textTransform: "uppercase", cursor: deleting ? "not-allowed" : "pointer", opacity: deleting ? 0.7 : 1 }}>
